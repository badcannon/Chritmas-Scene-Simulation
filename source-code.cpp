...
void welcome_screen()
{
	...
	strcpy(welcome[2],"PRESENTED BY:");
	strcpy(welcome[3],"Rishabh Jain (1MV12CS082)");
	strcpy(welcome[4],"Prerna Singh (1MV12CS075)");
	strcpy(welcome[5],"Press s to Start the Simulation");
